...
class _AddIncomeState extends State<AddIncome> {
  ...
  // shoDialogAddFile(BuildContext context) async {
  //   Future.delayed(
  ...
  Future<void> _selectTime(BuildContext context) async {
    ...
    if (pickedTime != null) {
      setState(() {
        ...
        print("this is $_selectedTime");
        print("this is ${_selectedTime.period.name.toUpperCase()}");
        formatTime =
  ...
  void _saveIncome() async {
    if (_formKey.currentState!.validate() && selectcatagorytital != null) {
      ...
      TransactionController.to.addTransaction(
          name, _noteController.text, amount, time, 1, cash, selectedcatId!);
    }
  }

  // void schedualeTransaction() async {
  //   if (_formKey.currentState!.validate() && selectcatagorytile != null) {
  //     double amount = double.parse(_amountController.text);
  //     String name = _nameController.text;
  //     String image = selectcatagorytile!.image;
  //     String imageUrl = "";
                          ...
                          child: SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText:
                                    "${AppLocalizations.of(context)!.income} (optional) ",
